...
a persistence unit "FrontEnd_Proj5PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "FrontEnd_Proj5\pom.xml":
...
artifact ("FrontEnd_Proj5.war") is already built. You can build
