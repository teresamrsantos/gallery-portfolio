...
a persistence unit "Cli_Projeto5PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Cli_Projeto5\pom.xml":
...
artifact ("Cli_Projeto5.war") is already built. You can build
